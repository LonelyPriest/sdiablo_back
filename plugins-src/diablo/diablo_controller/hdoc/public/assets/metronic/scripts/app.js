...
var App = function () {
    ...
    var handleFixedSidebarHoverable = function () {
        ...
        $('.page-sidebar').off('mouseleave').on('mouseleave', function () {
            ...
            if ((body.hasClass('page-sidebar-hover-on') === false
	    	 || body.hasClass('page-sidebar-fixed') === false)
	    	|| $(this).hasClass('page-sidebar-hovering')) {
                return;
            }
    ...
    // var handleColosedSidebarMouseLeave = function(){
    // 	// $('.page-sidebar').off('mouseleave').on('mouseleave', function () {
    // 	//     // console.log("mouse leave");
    // 	//     var body = $('body');
    // 	//     body.removeClass('page-sidebar-closed').addClass('page-sidebar-closed');
    // 	// });
    // }
	...
	// diablo add
	jQuery('body').on('click', '.portlet > .portlet-title > .actions > .btn-group > button.reload', function (e) {
	    e.preventDefault();
	    var el = jQuery(this).closest(".portlet").children(".portlet-body");
            App.blockUI(el);
            window.setTimeout(function () {
	...
	jQuery('body').on('click', '.portlet > .portlet-title > .actions > .btn-group-solid > a.reload', function (e) {
	    e.preventDefault();
	    var el = jQuery(this).closest(".portlet").children(".portlet-body");
            App.blockUI(el);
            window.setTimeout(function () {
	...
	scrollDirect: function(number){
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="/public/assets/metronic/img/ajax-loading.gif" align="">',
