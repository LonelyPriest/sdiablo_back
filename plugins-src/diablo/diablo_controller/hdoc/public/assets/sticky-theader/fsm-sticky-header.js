...
(function(angular){
    ...
    fsm.directive('fsmStickyHeader', [function(){
		...
		// console.log(scope.scrollableContainer);
		...
		scope.scrollStop = angular.isDefined(scope.scrollStop)
		    ? scope.scrollStop : 50;
		    ...
		    'scroll.fsmStickyHeader',
		    determineVisibility).trigger("scroll");
		
                scrollableContainer.on(
		    'resize.fsmStickyHeader', determineVisibility);

		scrollableContainer.on(
		    'click.fsmStickyHeader', 
		    determineVisibility());
