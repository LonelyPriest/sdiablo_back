...
function needCLodop(){
	...
	if (ua.match(/Windows\sPhone/i) !=null) return false;
	if (ua.match(/iPhone|iPod|iPad/i) != null) return false;
...
function getLodop(oOBJECT,oEMBED){
	...
	LODOP.SET_LICENSES("","4D7874792841C6D8BF21DC9D59673C7B","C94CEE276DB2187AE6B65D56B3FC2848","A98059EB205FCC8E7B4BF6DD38F47BF0");
        //===========================================================
        return LODOP;
