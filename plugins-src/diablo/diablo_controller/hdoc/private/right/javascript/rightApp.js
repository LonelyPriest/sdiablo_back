...
define(["angular"], rightConfig);

function rightConfig(angular){
	...
	var httpMerchant = $resource("/merchant/:operation/:id");
	this.list_merchant = function(){
	    return httpMerchant.query({operation: "list_merchant"})};
    });
