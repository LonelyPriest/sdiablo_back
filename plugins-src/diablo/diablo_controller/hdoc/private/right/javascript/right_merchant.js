...
function roleMerchantNewCtrlProvide($scope, $q, $location, diabloUtilsService, rightService){
...
function roleMerchantDetailCtrlProvide($scope, $q, $uibModal, rightService, diabloUtilsService){
    // console.log($scope);
...
// merchant account
// =============================================================================
function accountMerchantNewCtrlProvide($scope, diabloUtilsService, rightService){

    $scope.merchants = [];
    rightService.list_merchant().$promise.then(function(merchants){
...
function accountMerchantDetailCtrlProvide(
...
define(["rightMerchantApp"], function(app){
    app.controller("roleMerchantNewCtrl", roleMerchantNewCtrlProvide);
    app.controller("roleMerchantDetailCtrl", roleMerchantDetailCtrlProvide);
    app.controller("accountMerchantNewCtrl", accountMerchantNewCtrlProvide);
    app.controller("accountMerchantDetailCtrl", accountMerchantDetailCtrlProvide);
});
