{application,diablo_controller,
             [{description,"diablo controller"},
              ...
              {modules,[diablo_controller,diablo_controller_sup,
                        ...
                        diablo_controller_supplier_request,
                        diablo_controller_supplier,diablo_firm_request,
                        diablo_purchaser_request,diablo_purchaser,
                        diablo_w_retailer,diablo_w_retailer_request,
                        diablo_w_sale,diablo_w_sale_request,
                        diablo_w_sale_draft,diablo_w_print,
                        diablo_w_print_request,diablo_format_print,
                        diablo_w_good_request,diablo_w_report_request,
                        diablo_w_report,diablo_w_base_request,diablo_w_base,
                        diablo_controller_right_init,diablo_controller_authen,
                        diablo_wuser_profile,base_frame,employ_frame,
                        inventory_frame,login,login_force,member_frame,
                        merchant_frame,right_frame,sale_frame,shop_frame,
                        supplier_frame,firm_frame,purchaser_frame,wsale_frame,
