{application,diablo_controller,
             [{description,"diablo controller"},
              ...
              {modules,[diablo_controller,diablo_controller_sup,
                        ...
                        diablo_batch_sale_request,diablo_batch_saler,
                        base_frame,base_require_frame,employ_frame,login,
                        login_force,member_frame,merchant_frame,right_frame,
                        sright_frame,shop_frame,supplier_frame,firm_frame,
                        purchaser_frame,wsale_frame,wretailer_frame,
                        wprint_frame,wgood_frame,sys_frame,wreport_frame,
                        bsale_frame]},
