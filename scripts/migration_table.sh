...
rsn, style_number, brand, color, size, total, exist, entry_date, merchant, deleted, shop) \
SELECT rsn, style_number, brand, color, size, total, exist, entry_date, merchant, deleted, shop \
