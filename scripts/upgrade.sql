...
--2020-07-01
update w_inventory_2 set state=RPAD(state,7,'0100000') where merchant=2 and length(state)=1;
...
alter table w_pay modify column sn VARCHAR(16) not null default '-1';
alter table w_sale modify column sn VARCHAR(16) not null default '-1';
